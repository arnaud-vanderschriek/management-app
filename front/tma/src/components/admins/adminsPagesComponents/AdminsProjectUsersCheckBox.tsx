...
import { DataProject, UsersList } from '..';
...
function AdminsProjectUsersCheckBox(props: Props) {
        ...
        <FormGroup>
          { props.userList.map((elem) => 
            <FormControlLabel
              control={ <Checkbox 
              checked={ 
                props.dataProject.usersOnProject ? 
                props.dataProject.usersOnProject.includes(elem.firstname) :
                false 
              } 
